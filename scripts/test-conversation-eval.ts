...
const GENERIC_UNSUPPORTED_TERM_RE =
  /^(?:生徒名|担当講師|講師名|対象生徒|面談日|実施日|面談時間|教科単元|主な扱い科目|扱った単元|学習内容|進路方針|生活面|確認事項|到達点|方針|共有ポイント|連携事項|自学習|テスト|現時点|短期的|基礎事項|確認対象|改善確認|授業内|授業前|授業後|授業冒頭|授業冒頭時点|前回宿題|宿題対応時|生徒本人|本記録内)$/;
