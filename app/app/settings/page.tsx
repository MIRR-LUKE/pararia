...
const OPERATIONS = [
  {
    title: "モード別ログ生成",
    description: "面談モードと指導報告モードを分け、録音後はそれぞれ面談ログと指導報告ログへ保存します。",
  },
  {
    title: "ログ選択型の保護者レポート",
    description: "保存済みログを自動混在させず、必要な面談ログと指導報告ログだけを選んで保護者レポートを作ります。",
  },
  {
    title: "共有履歴を残す",
    description: "送信、再送、手動共有の記録を残し、Student Room と補助画面から追えるようにします。",
  },
];
