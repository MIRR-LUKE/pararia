...
export function useStudentSessionConsoleController({
  studentId,
  studentName,
  mode,
  lessonPart,
  ...
  const showGenerationProgress =
    Boolean(generationProgress) && !(mode === "LESSON_REPORT" && lessonPart === "CHECK_IN");
  ...
  return {
    ...
    onLessonPartChange,
    onModeChange,
    openCancelDialog: requestCancelRecording,
